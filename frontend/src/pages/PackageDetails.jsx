                  ...
                  <ul className="space-y-2">
                    {pkg.deliverables.map((item, idx) => (
                      <li key={idx} className="flex items-start gap-2">
                        <svg
                          className="w-5 h-5 text-primary-dark mt-0.5"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
              ...
              {pkg.creator && (
                <div className="mb-8 bg-light rounded-2xl p-6">
                  ...
                  <div className="flex items-center gap-2 text-gray-700">
                    ...
                    <span className="font-semibold">{pkg.creator.follower_count?.toLocaleString() || '0'} Followers</span>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-sm hover:shadow-md transition-shadow p-6 sticky top-8">
              ...
              <div className="border-t border-gray-200 pt-4 mt-4 space-y-3">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span>Secure Payment - all Payment Methods Accepted</span>
                </div>
