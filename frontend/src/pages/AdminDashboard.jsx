      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard
            ...
            value={stats.users.pending_verifications}
            color="orange-600"
            icon={
              <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <StatCard
              ...
              value={stats.financial.pending_payments_count || 0}
              subtitle={`$${(stats.financial.pending_payments_amount || 0).toLocaleString()} pending`}
              color="yellow-600"
              icon={
                <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <StatCard
              ...
              value={`$${(stats.financial.escrowed_amount || 0).toLocaleString()}`}
            ...
            <StatCard
              ...
              value={stats.financial.pending_cashouts_count || 0}
              subtitle={`$${(stats.financial.pending_cashouts_amount || 0).toLocaleString()} requested`}
              color="orange-600"
              icon={
                <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-sm text-gray-600">
            Average rating from {stats.reviews?.total || 0} reviews
          </p>
        </div>
      </div>
