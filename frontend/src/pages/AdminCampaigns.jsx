  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold text-gray-900 leading-tight">Campaign Management</h1>
          <p className="text-gray-600 leading-relaxed mt-2">Monitor and manage all campaigns</p>
        </div>
              ...
              <div className="border-t border-gray-200 pt-4 mt-4">
                ...
                <div className="flex gap-2">
                  <Link
                    ...
                    className="px-4 py-2 bg-primary text-dark rounded-lg hover:bg-primary-dark hover:text-white transition text-sm"
                  >
                    View Details
                  </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg shadow-md p-4">
          ...
          <p className="text-2xl font-bold text-primary-dark">{campaigns.length}</p>
        </div>
        <div className="bg-white rounded-lg shadow-md p-4">
