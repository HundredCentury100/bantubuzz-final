    ...
    <div className="min-h-screen bg-light">
      ...
      <div className="container-custom section-padding">
        ...
        {profileComplete && connectedPlatforms.length === 0 && (
          <div className="mb-6 p-6 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-3xl">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-gray-900 text-lg mb-2">Connect Your Social Media Accounts</h3>
                <p className="text-sm text-gray-700 mb-4 leading-relaxed">
                  Link your Instagram, TikTok, YouTube, Facebook, and X (Twitter) accounts to automatically sync your follower counts and showcase your reach to brands. This helps increase your chances of getting booked!
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="inline-flex items-center gap-1 px-3 py-1 bg-white/80 text-gray-700 rounded-full text-xs font-medium">
                  ...
                  <span className="px-3 py-1 bg-white/80 text-gray-700 rounded-full text-xs font-medium">+ More</span>
                </div>
                <Link
                  to="/creator/platforms"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white rounded-full transition-all text-sm font-semibold shadow-lg hover:shadow-xl"
                >
                  Connect Platforms
