...
const PaymentReturn = () => {
  ...
  useEffect(() => {
    ...
    console.log('PaymentReturn - All URL params:', allParams);

    // Check URL parameters from Paynow
    const reference = searchParams.get('reference');
    const status = searchParams.get('status');

    // Check localStorage for booking ID
    const lastBookingId = localStorage.getItem('lastBookingId');
    console.log('LastBookingId from localStorage:', lastBookingId);
    ...
    if (reference && status) {
      ...
      // We have a booking ID from localStorage
      console.log('Using localStorage booking ID');
      setPageData({
        status: 'pending',
        title: 'Payment Submitted',
        message: 'Thank you! We are confirming your payment. This may take a few moments.'
      });
      ...
      setPageData({
        ...
        message: 'Please check your dashboard for payment status.'
      });
    }
  }, [searchParams]);
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex">
            ...
            <div>
              <h3 className="font-medium text-blue-900 mb-1">Payment Processing</h3>
              <p className="text-sm text-blue-800">
                Payment confirmations may take a few minutes. Check your dashboard to see your booking status.
