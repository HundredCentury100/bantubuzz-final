    ...
    >
      ...
      <div className="px-4 pb-4">
        ...
        {(creator.city || creator.country || creator.location) && (
          <div className={`flex items-center gap-1 mb-3 text-xs ${textColor === 'white' ? 'text-gray-600' : 'text-gray-600'}`}>
        ...
        {creator.cheapest_package_price && (
          <div className="mb-3 text-center">
            <p className={`text-xs mb-0.5 ${textColor === 'white' ? 'text-gray-600' : 'text-gray-600'}`}>Starting from</p>
            <p className={`text-lg font-semibold ${textColor === 'white' ? 'text-gray-900' : 'text-dark'}`}>
              ${creator.cheapest_package_price}
            </p>
          </div>
        )}
