...
const CustomPackageRequestModal = ({ creatorId, creatorName, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        onSuccess && onSuccess(response.data.request);
        onClose();
      }
    } catch (error) {
      console.error('Error creating custom request:', error);
      toast.error(error.response?.data?.error || 'Failed to send custom package request');
    } finally {
      setSubmitting(false);
    }
  };
      ...
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h2 className="text-2xl font-bold text-dark">Request Custom Package</h2>
              <p className="text-sm text-gray-600 mt-1">Tell {creatorName} what you need</p>
            </div>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <p className="mt-1 text-sm text-gray-500">
                This is your proposed budget. The creator will send you a custom offer.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                placeholder="Any additional requirements or context the creator should know..."
                rows="4"
...
export default CustomPackageRequestModal;
