...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <nav className="bg-white shadow-sm fixed top-0 left-0 right-0 z-30">
        <div className="flex items-center justify-between h-16 px-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-gray-900">BantuBuzz Admin</h1>
          </div>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-16 bottom-0 w-64 bg-white shadow-lg transform transition-transform duration-300 z-20 ${
