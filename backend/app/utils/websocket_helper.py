...
def emit_message_to_websocket(message, db_session):
    ...
    try:
        ...
        message_data = {
            ...
            'attachment_type': getattr(message, 'attachment_type', None),
            'attachment_name': getattr(message, 'attachment_name', None),
            'attachment_mime_type': getattr(message, 'attachment_mime_type', None),
