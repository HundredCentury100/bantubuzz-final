...
class CreatorScore(db.Model):
    ...
    order_completion_score = db.Column(db.Numeric(6, 3), nullable=False, default=0)
    response_rate_score = db.Column(db.Numeric(6, 3), nullable=False, default=0)
    on_time_delivery_score = db.Column(db.Numeric(6, 3), nullable=False, default=0)
    marketplace_reliability_score = db.Column(db.Numeric(6, 3), nullable=False, default=0)
    review_score = db.Column(db.Numeric(6, 3), nullable=False, default=0)
    profile_trust_score = db.Column(db.Numeric(6, 3), nullable=False, default=0)
