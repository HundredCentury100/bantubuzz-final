...
BACKUP="/var/backups/bantubuzz/agency-subscription-payment-before-$TS"
...
rm -f \
  /tmp/bantubuzz-agency-subscription-payment-backend.tar.gz \
  /tmp/bantubuzz-agency-subscription-payment-frontend.tar.gz \
  /tmp/deploy-agency-subscription-payment-fix.sh

echo BANTUBUZZ_NEW_VPS_AGENCY_SUBSCRIPTION_PAYMENT_FIX_SUCCESS
