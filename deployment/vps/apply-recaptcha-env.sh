...
tmp_env="$(mktemp)"
grep -v -E '^(RECAPTCHA_ENTERPRISE_SITE_KEY|RECAPTCHA_ENTERPRISE_PROJECT_ID|RECAPTCHA_ENTERPRISE_API_KEY|RECAPTCHA_ENTERPRISE_MIN_SCORE|RECAPTCHA_ENTERPRISE_ALLOWED_HOSTNAMES)=' "$ENV_FILE" > "$tmp_env" || true
{
  echo ""
